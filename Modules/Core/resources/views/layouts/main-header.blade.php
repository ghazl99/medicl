    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="{{ route('dashboard') }}"><img src="{{ URL::asset('assets/img/brand/logo.png') }}" class="logo-1"
                        alt="logo"></a>
                <a href="{{ route('dashboard') }}"><img src="{{ URL::asset('assets/img/brand/logo-white.png') }}"
                        class="dark-logo-1" alt="logo"></a>
                <a href="{{ route('dashboard') }}"><i class="fa fa-capsules p-1 logo-2"></i></a>
                <a href="{{ route('dashboard') }}"><i class="fa fa-capsules p-1 dark-logo-2"></i></a>
            </div>
        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown nav-item main-header-notification theme-toggle"
                    style="background-color: #f8f9fa; border-radius: 50%; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
