        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"
                    value="{{ old('name') }}" placeholder="ادخل اسم الدواء" required autofocus />
                @error('name')
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('manufacturer') is-invalid @enderror" id="manufacturer"
                    name="manufacturer" value="{{ old('manufacturer') }}" placeholder="ادخل اسم الشركة المصنعة" />
                @error('manufacturer')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="number" class="form-control @error('quantity_available') is-invalid @enderror" id="quantity_available"
                    name="quantity_available" value="{{ old('quantity_available', 0) }}" placeholder="ادخل الكمية المتوفرة" required min="0" />
            ...
            <div class="col-md-6">
                ...
                <input type="text" step="0.01" class="form-control @error('price') is-invalid @enderror" id="price"
                    name="price" value="{{ old('price') }}" placeholder="ادخل سعر الدواء" required min="0" />
                @error('price')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
