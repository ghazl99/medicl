...
@endsection
@section('content')
        <div class="card" style="margin: 80px 20px">
            <div class="card-body">
                    ...
                    <div class="row g-3">
                        @hasanyrole('المشرف|صيدلي')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                    name="name" value="{{ old('name', $user->name) }}" placeholder="ادخل اسم المستخدم"
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="cities[]" id="cities"
                                class="form-control @error('cities') is-invalid @enderror" multiple>
