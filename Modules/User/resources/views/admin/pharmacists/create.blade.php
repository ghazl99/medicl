        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"
                    value="{{ old('name') }}" placeholder="ادخل اسم المستخدم" required autocomplete="name" autofocus />
                @error('name')
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('workplace_name') is-invalid @enderror" id="workplace_name"
                    name="workplace_name" value="{{ old('workplace_name') }}" placeholder="اسم الصيدلية أو الشركة"
                    required />
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('city') is-invalid @enderror" id="city" name="city"
                    value="{{ old('city') }}" placeholder="اسم المدينة" required />
                @error('city')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
            ...
            {{-- الدور مخفي --}}
            <input type="hidden" name="role" id="role" value="صيدلي" />
            @error('role')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
